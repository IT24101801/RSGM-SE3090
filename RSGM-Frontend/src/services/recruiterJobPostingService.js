...
export function createRecruiterJobPosting(
  job
) {
  return request(
    "/api/recruiter/postings",
...
export function updateRecruiterJobPosting(
  id,
  job
) {
  return request(
    `/api/recruiter/postings/${id}`,
    {
      method: "PUT",
      body: JSON.stringify(job),
    }
...
export function updateRecruiterJobStatus(
  ...
  return request(
    `/api/recruiter/postings/${id}/status`,
    {
      method: "PATCH",
      body: JSON.stringify({
        status,
...
export function deleteRecruiterJobPosting(
  id
) {
  return request(
    `/api/recruiter/postings/${id}`,
