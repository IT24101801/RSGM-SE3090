  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-neutral-900">
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-32 left-[15%] w-105 h-105 bg-emerald-300/25 blur-[140px] rounded-full" />
        <div className="absolute top-[50%] -right-40 w-100 h-100 bg-teal-200/30 blur-[140px] rounded-full" />
      </div>
          ...
          <div className="px-4 py-5 border-t border-neutral-200/70">
            <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-neutral-50">
              ...
              <div className="min-w-0">
                <p className="text-sm font-medium truncate">{user?.email ?? "HR Manager"}</p>
